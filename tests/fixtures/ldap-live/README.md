...
The checks cover StartTLS with explicit or omitted LDAP v3, rejection of LDAP v2 with requested StartTLS, correct and incorrect credentials, group membership, UTF-8 usernames, LDAP attribute casing, literal filter metacharacters, and attribute fallback after successful binding. They do not certify Active Directory, deployment certificates, or REDCap's configured LDAP directories.
